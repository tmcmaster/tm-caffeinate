...
/**
 * `tm-caffeinate`
 * Polymer component for stopping screensaver and screen lock functionality.
 *
 * @customElement
 * @polymer
 * @demo demo/index.html
 */
class TmCaffeinate extends PolymerElement {
  static get template() {
    return html`
      <style>
        :host {
      ...
      <paper-toggle-button checked="{{disable}}">Disable Screen Lock</paper-toggle-button>
  ...
  ready() {
    ...
    this.content = `
        ...
        <html lang="en">
          <body>
            <h4>Screen Save/Lock has been disabled.</h4>            
            <script>
                console.log('Loading on NoSleep.');
                
                // The NoSleep.min.js has been copied here, because it was not playing nicely with polymer web components.
                //  This is a work around, where the javascript is imbedded within an iframe.
...
window.customElements.define('tm-caffeinate', TmCaffeinate);
