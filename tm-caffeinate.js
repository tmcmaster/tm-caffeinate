  ...
  ready() {
    ...
    const content = `
        ...
        <html lang="en">
          ...
          <body>
            <!--wwqweee-->
            <!--<script src="/bower_components/nosleep/dist/NoSleep.min.js"></script>-->
            ...
            <script>
                ...
                window.onload = function() {
                  ...
                  toggleEl.addEventListener('click', function() {
                      if (!wakeLockEnabled) {
                          console.log('Turning on NoSleep.');
                          noSleep.enable(); // keep the screen on!
                          wakeLockEnabled = true;
                          toggleEl.value = "Wake Lock is enabled";
                          document.body.style.backgroundColor = "green";
                      } else {
                          console.log('Turning off NoSleep.');
                ...
                // TODO:  This event is not being triggerd
